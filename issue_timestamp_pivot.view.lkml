   ...
   with field_categories as (
        ...
        from (
          select
            ...
            ,fc.field_name
            ,case when lower(fc.field_name) in ('impact start time', 'stable time') then imh.value else fo.name end as field_value
          ...
          select
            ...
            ,issue.id as issue_id
            ,fc.field_name
            ,case when lower(fc.field_name) in ('impact start time', 'stable time') then ifh.value else fo.name end as field_value
          from fivetran.jira.issue issue
